...
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">Electronics</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="cycle.php">Cycling</a> 
                </div>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
       <?php  
      $query = "SELECT * FROM products1 where Category='Tablet' ORDER BY Id ASC";  
