...
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle active" href="#" id="navdrop" data-toggle="dropdown">Sports</a>
                <div class="dropdown-menu">
    ...
    <div class="container">
      <br>
     <h2 align="center">Badmitton Accessories</h2> 
    <div class="row">
       <?php  
      $query = "SELECT * FROM products1 where Category='Badmitton' ORDER BY Id ASC";  
